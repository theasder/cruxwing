...
1. **Russian strings on screen.** A task with a known number, and the direction
   reversed on 2026-09-09: the interface is moving to English. Of the 438 strings
   a person reads in `app/Sources/MeetGPT/Views` and `Onboarding`, 116 still carry
