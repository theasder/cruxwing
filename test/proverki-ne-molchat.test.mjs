...
// Состояние СБОРКИ, а не подставленное в самом тесте: именно оно делает
// проверку молчаливой на одной машине и говорящей на другой.
const BUILD_STATE = /\bConfig\.|\bSecrets\./;
