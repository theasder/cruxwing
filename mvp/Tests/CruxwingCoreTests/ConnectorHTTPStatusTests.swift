...
/// сломанный обратный прокси (502 и страница HTML вместо JSON), — и `cruxwing
...
struct ConnectorHTTPStatusTests {
    ...
    func labelHasASingleImplementation() throws {
        ...
        let root = URL(fileURLWithPath: #filePath)
            ...
            .deletingLastPathComponent().deletingLastPathComponent()
        for file in ["mvp/Sources/CruxwingCore/ConnectorQuery.swift",
    ...
    func limitMatchesWhatWeAsk() throws {
        ...
        let source = try String(
            contentsOf: URL(fileURLWithPath: #filePath)
                ...
                .appendingPathComponent("Sources/CruxwingCore/SelfHostedTrackers.swift"),
            encoding: .utf8)
