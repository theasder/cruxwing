...
///
/// Живёт в исполняемой цели, а не в ядре: `CruxwingCore` не знает про AVFoundation
    ...
    enum RecordingError: Error, CustomStringConvertible {
        ...
        var description: String {
            ...
            case .unsupportedPlatform:
                ...
                отдайте его — `cruxwing расшифровать звонок.wav "Title"` \
                (с `CRUXWING_ENGINE`) или `cruxwing добавить расшифровка.txt "Title"`.
                """
            }
        }
    }
