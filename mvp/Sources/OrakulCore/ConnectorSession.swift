...
/// «Foundation защищает» не существует. Командная строка orakul работает именно
...
public enum ConnectorSession {
    ...
    public static let session: URLSession = {
        ...
        // продукт называется orakul. Измерено 2026-08-21 на своём сервере,
