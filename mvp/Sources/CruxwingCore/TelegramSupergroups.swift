...
public struct TelegramSupergroups: Sendable {
    ...
    public enum ConnectorError: Error, Equatable, LocalizedError, Sendable {
        ...
        public var errorDescription: String? {
            ...
            case .webhookConflict:
                return "The bot already has a webhook enabled. One bot cannot receive updates through a webhook and through cruxwing at the same time; create a separate bot or delete the webhook."
