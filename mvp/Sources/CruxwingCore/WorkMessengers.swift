    ...
    public enum Service: String, CaseIterable, Sendable {
        ...
        public var credentialHint: String {
            ...
            case .slack:
                ...
                return "A PERSONAL user token with the search:read scope. Slack does not allow message search from a bot, so the token reaches everything you can see, direct messages included. cruxwing discards direct messages and private channels before anything reaches a hint, but the token itself is issued for everything"
            case .pachca:
        ...
        /// же 401, что и на протухший ключ, и без проверки cruxwing советовал
