...
/// У cruxwing нет тарифов. Это свойство продукта, а не текущее состояние прайса,
...
struct NoTariffsTests {
    ...
    func everyModelIsAvailable() {
        ...
        // которых взять неоткуда: платить cruxwing не за что.
...
struct NoPricingScreenTests {
    ...
    /// заголовком «Тарифы cruxwing» и планами. Репозиторий открытый, и это
