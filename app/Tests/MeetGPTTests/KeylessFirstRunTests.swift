...
/// Что видит разработчик, который поставил cruxwing и ещё не вставил ключ.
///
...
/// совет из Cruxwing, у которого есть сервер. У cruxwing его нет, и человек по
...
struct KeylessFirstRunTests {
    ...
    func missingKeyPointsAtTheScreen() throws {
        ...
        #expect(!message.lowercased().contains("sign in"),
                "совет войти в аккаунт: сервера у cruxwing нет")
