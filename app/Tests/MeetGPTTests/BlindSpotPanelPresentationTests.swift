...
struct BlindSpotPanelPresentationTests {
    ...
    func offWithoutCards() {
        ...
        #expect(panel.heading == "Hints are off")
        #expect(panel.statusMessage == "Turn on blind-spot detection in settings to continue.")
    ...
    func pausedWithCards() {
        ...
        #expect(panel.heading == "Hints are paused")
    ...
    func activeFailure() {
        ...
        #expect(panel.heading == "Hints as you go")
