...
struct ConsequenceRankerTests {
    ...
    func flaggedFiguresAreCapped() {
        ...
        let footer = String(audited.markdown[audited.markdown.range(of: "Check these figures")!.upperBound...])
