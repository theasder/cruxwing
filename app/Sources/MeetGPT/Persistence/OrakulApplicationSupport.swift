...
/// The sole root for Orakul-owned files in Application Support.
///
...
/// transcripts and connected-service messages inside Orakul.
enum OrakulApplicationSupport {
    ...
    static let directoryName = "ai.orakul.desktop"
    ...
    static func resolvedRoot(applicationSupportDirectory: URL?,
        ...
        if isUnderTest {
            ...
            .appendingPathComponent("orakul-tests", isDirectory: true)
            return root(in: base)
        }
