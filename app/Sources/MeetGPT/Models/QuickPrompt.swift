...
enum QuickPrompts {
    ...
    static let all: [QuickPrompt] = [
        .init(id: "agenda",
              icon: "🗓️",
              title: "Agenda so far",
              tooltip: "The agenda by time: who is leading, and what we are deferring",
        ...
        .init(id: "brainstorm",
              icon: "💡",
              title: "Brainstorm",
              tooltip: "Gather ideas with the reasoning and the next steps",
        ...
        .init(id: "unresolved",
              ...
              tooltip: "What is still open: who owns it, and by when",
        ...
        .init(id: "whattoask",
              icon: "🎯",
              title: "What to ask",
              tooltip: "What was skipped or talked around — with questions ready to ask",
        ...
        .init(id: "factcheck",
              icon: "🔎",
              title: "Fact check",
              tooltip: "Check the facts that were stated and mark what held up",
        ...
        .init(id: "rhetoric",
              icon: "🎭",
              title: "Rhetorical moves",
              tooltip: "Find the substitutions, the pressure and the loaded questions",
        ...
        .init(id: "answer",
              ...
              tooltip: "Answer the last question that was put to you",
        ...
        .init(id: "dispute",
              icon: "🤝",
              title: "Settle the disagreement",
              tooltip: "What the disagreement is, and what the options are",
        ...
        .init(id: "risks",
              ...
              tooltip: "A list of risks: likelihood and consequence",
        ...
        .init(id: "advice",
              icon: "🧭",
              title: "Give advice",
              tooltip: "What to do next, given your role",
        ...
        .init(id: "tasks",
              icon: "📋",
              title: "Tasks from this call",
              tooltip: "Assign the tasks and collect the action list",
        ...
        .init(id: "logdecision",
              ...
              tooltip: "Write the decision that was made into the log",
        ...
        .init(id: "summary",
              icon: "📝",
              title: "Call summary",
              tooltip: "Break the call down into points",
        ...
        .init(id: "steelman",
              ...
              tooltip: "The strongest argument against what was agreed",
        ...
        .init(id: "commitments",
              icon: "🔗",
              title: "Commitments",
              tooltip: "What was promised before, and whether this call closed it",
        ...
        .init(id: "recall",
              ...
              tooltip: "An answer from earlier calls — with the quote and the title",
